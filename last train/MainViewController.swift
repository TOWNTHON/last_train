...
class MainViewController: UIViewController {
    ...
    override func viewDidLoad() {
        super.viewDidLoad()
        nearTrainStop.text = "あいうえお"
        lastTrainTime.text = "23:40"
    ...
    @IBOutlet weak var nearTrainStop: UILabel!
    
    @IBOutlet weak var lastTrainTime: UILabel!
    
    @IBAction func checkRoot(_ sender: Any) {
